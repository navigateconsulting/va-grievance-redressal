...
import { ManageGrievanceComponent } from './manage-grievance/manage-grievance.component';
import { GrievanceChatComponent } from './grievance-chat/grievance-chat.component';
import { GrievanceAppComponent } from './grievance-app/grievance-app.component';
...
@NgModule({
  declarations: [
    ...
    ManageGrievanceComponent,
    GrievanceChatComponent,
    GrievanceAppComponent,
  ],
  entryComponents: [
    AddEntityComponent,
    EditEntityComponent,
